...
{
	enum enTransactionsMenuOptions { eDeposit = 1, eWithdraw = 2, eTotalBlances = 3,eTransfer = 4, eMainMenue = 5 };

	static short _ReadTransactionsMenuOptions( )
	{
		short NumberOfOption = 0;
		cout << "Chose what do you want to do? [1 to 4]?";
		NumberOfOption = clsInputValidate::ReadShortNumberBetween(1, 4);
	...
	static void _PrefromTransactionsMenu(enTransactionsMenuOptions ClientOption)
	{
		switch (ClientOption)
		{
...
public:
	static void ShowTransactionsMenu()
	{
		...
		cout << "\t[5] Main Menue.\t\t\t\t    |\n";
		cout << "-----------------------------------------------------\n";
		_PrefromTransactionsMenu((enTransactionsMenuOptions)_ReadTransactionsMenuOptions());
	}
};
